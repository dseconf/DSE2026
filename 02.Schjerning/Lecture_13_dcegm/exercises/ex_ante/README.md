...
This is the **student version** of the exercises. Several core calculations are intentionally left for you to complete. Completed reference implementations are available in [`../ex_post`](../ex_post/).
