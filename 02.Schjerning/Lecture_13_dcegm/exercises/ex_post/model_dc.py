...
class model_dc():
    """Discrete-continuous work/retirement model solved by DC-EGM.

    Choice index 0 means working next period and index 1 means retired.
    """
    ...
    def create_grids(self):
        """Construct income-shock quadrature and the end-of-period asset grid."""
    ...
    def solve(self):
        """Solve choice-specific policies and values by backward induction."""
