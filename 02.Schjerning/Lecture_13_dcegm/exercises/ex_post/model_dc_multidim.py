...
class model_dc_multidim():
    """DC-EGM retirement model with permanent income as an extra state."""
    ...
    def setup(self):
        """Set economic parameters and multidimensional grid defaults."""
    ...
    def create_grids(self):
        """Construct shock, asset, cash-on-hand, and permanent-income grids."""
    ...
    def solve(self):
        """Solve backward over choices and permanent-income grid points."""
