...
- [run_lecture2_walkthrough.m](run_lecture2_walkthrough.m): Sectioned live-teaching script for DSE 2026. It maps model primitives, the Bellman operator, the fixed-point solver, NFXP, and MPEC directly to the corresponding lecture derivation. Run one `%%` section at a time in MATLAB.

- [run_lecture2_demo.m](run_lecture2_demo.m): Short, deterministic classroom demonstration for DSE 2026 Lecture 2. Simulates one sample and estimates the same partial maximum-likelihood problem with NFXP and MPEC, then prints a compact comparison of parameters, log likelihoods, and runtimes.
